...
from modules import admin, afk, ascii as ascii_mod, dumper, info, kang, approve, log as log_mod, towa, unpack
...
OUTGOING_MODULES = [afk, log_mod, info, dumper, ascii_mod, approve, admin, kang, towa, unpack]
